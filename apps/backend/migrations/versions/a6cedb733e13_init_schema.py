...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_events_published_to_stream"),
        "events",
        ["published_to_stream"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("revenue_at_risk", sa.Numeric(precision=18, scale=4), nullable=True),
        sa.Column("currency", sa.String(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("dispersion", sa.Numeric(precision=18, scale=4), nullable=True),
        sa.Column("config_version", sa.String(), nullable=False),
        sa.ForeignKeyConstraint(
            ["restaurant_id"],
            ["restaurants.id"],
